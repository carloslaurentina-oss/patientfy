      ...
      <section className="pt-28 pb-12 lg:pt-36 lg:pb-16 bg-neutral-1000 text-white">
        <div className="container-large padding-global">
          <div className="max-w-2xl flex flex-col gap-4">
            <Eyebrow variant="light">Meet your doctor</Eyebrow>
            <h1 className="text-4xl lg:text-5xl font-semibold tracking-tight text-white">Dr. John Smith</h1>
            <p className="text-base text-white/70">Lead Dentist & Founder</p>
          </div>
        </div>
      </section>
